...
(function (global) {
  var H5 = {
    displayDisclaimer: '本页内容仅供参考。实际方案与费用请与商家线下确认。',
    geoDisclaimer:
      '公开前须上传者确认已脱敏并勾选真实性承诺；平台不做线下验真。',
    trustLine:
      '公开前须上传者确认已脱敏并勾选真实性承诺；平台不做线下验真。',
    siteName: '辙见公开案例站',
    ownerLead: '这里展示用户选择公开的案例。现阶段以修理厂商家为主。',
    emptyCategory: '这一类暂时还没有公开案例。',
    emptyNext:
      '你可以先浏览其他分类，或了解辙见怎么上传（微信搜「辙见」）。欢迎修理厂商家上传并选择公开。',
    casePrice:
      '当时方案里的金额仅供参考，实际费用以到店检测为准。',
    price:
