  ...
  sections: [
    {
      heading: '产品说明',
      body:
        '辙见是汽车维修案例展示与咨询预约工具，提供案例浏览、咨询转接与服务相册功能，不参与线下维修服务、收款、发票与售后。',
    },
    {
      heading: '用户行为规范',
      body:
        '你应合法、真实地使用辙见功能，不得上传含完整车牌、人脸、证件等敏感信息的内容，不得发布虚假承诺、诱导分享或违规营销信息。',
    },
    {
      heading: '服务相册与授权',
      body:
...
const PRIVACY_POLICY = {
  ...
  sections: [
    ...
    },
    {
      heading: '信息使用',
      body:
        '信息用于账号识别、咨询转接、相册归属、脱敏审核与账号安全。未经你授权，不在公开场景展示完整手机号、车牌或 VIN。',
    },
    {
      heading: '公开与分享',
      body:
        '授权公示的案例经脱敏后公开展示。你自主分享给好友的内容由你本人控制；私人分享链接不等同于授权公示。',
    },
    {
      heading: '你的权利',
      body:
...
const DEACTIVATE_NOTICE = {
  title: '账号注销说明',
  body:
    '注销后账号将不可登录，咨询记录与服务相册查看权限将按法规与隐私政策保留或匿名化处理。辙见不提供交易与资金托管，注销不涉及退款处理。已公开且已授权的案例可能按规则下线或匿名化。',
