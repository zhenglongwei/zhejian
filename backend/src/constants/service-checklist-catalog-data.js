  ...
  "maintenance": {
    ...
    "items": [
      ...
      },
      {
        ...
        "workOnly": false,
        "group": "机油机滤",
        "noteExample": "旧油颜色/杂质/液位过浅等；若需处理或更换则标记后进入施工待处理，并解锁新机油规格与液位项。",
        "strength": "tip",
        "linkHint": "检测取样或举升观察；放油特写也可挂本项"
      },
      {
        "itemKey": "engine_oil",
        "label": "新机油规格",
        ...
        "workOnly": true,
        "group": "机油机滤",
        "noteExample": "规格 ××（如 0W-20）；品牌××；桶标/加注留影。",
        "strength": "strong",
        "linkHint": "**衍生项**：仅当 `old_oil` 进待处理后出现；拍新油桶标与加注"
      },
      {
        "itemKey": "oil_filter",
        "label": "机油滤芯",
        ...
        "strength": "strong",
        "linkHint": "**衍生项**：随 `old_oil` 进待处理解锁；新旧滤芯与包装"
      },
      {
        ...
        "workOnly": true,
        "group": "机油机滤",
        "noteExample": "更换加注后，热车/静置液位在标尺正常区间。",
        "strength": "strong",
        "linkHint": "**衍生项**：随 `old_oil` 进待处理解锁；拍机油尺/侧视窗"
      },
      {
      ...
      },
      {
        ...
        "label": "下次保养建议",
        "suggestStageId": "stage_6",
        "workOnly": false,
        "group": "交付建议",
        "noteExample": "建议下次约 ××km 或 × 个月（以手册与用车环境为准）。",
        "strength": "tip",
        "linkHint": "**完工**交代；以文字为主"
      }
    ]
  },
  "major_maintenance": {
