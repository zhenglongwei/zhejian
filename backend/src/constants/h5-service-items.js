...
const H5_SERVICE_ITEMS = [
  {
    ...
    faq: [
      ...
      {
        q: '小保养一般包含哪些项目？',
        a: '常见包含机油、机滤更换与常规检查，具体以门店套餐和车辆检测结果为准，不同车型项目可能略有差异。',
      },
      {
        q: '保养周期怎么判断？',
        a: '可参考厂家手册的建议里程或时间，并结合机油状况、提示灯与实际使用情况。到期或提示灯亮起时建议预约检查。',
      },
      {
        q: '可以只检查不保养吗？',
        a: '可以。到店后可先确认机油与滤芯状态，了解套餐范围后再决定是否施工。',
      },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      {
        q: '刹车片多久需要更换？',
        a: '没有固定公里数，需结合片厚、磨损均匀度、异响和制动表现综合判断。出现异响或制动距离变长时建议尽快检查。',
      },
      {
        q: '可以先检测再决定是否更换吗？',
  ...
  },
  {
    ...
    faq: [
      ...
      {
        q: '换电瓶大概需要多久？',
        a: '常规更换多数在 30–60 分钟内可完成，具体以车型与是否需要复位为准。',
      },
      {
        q: '页面价格是最终价格吗？',
        a: '不是。费用会因电瓶品牌、容量和车型匹配规格而不同，实际以门店检测报价为准。',
      },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      {
        q: '补漆和钣金喷漆有什么区别？',
        a: '补漆多用于局部漆面损伤；钣金喷漆通常包含整形、打磨与喷漆。具体范围需到店查看损伤后再确认。',
      },
      {
        q: '钣喷大概需要几天？',
        a: '视损伤面积、是否钣金和门店排期而定，常见为 1–3 天，施工前可向门店确认工期。',
      },
      {
        q: '页面价格是最终价格吗？',
        a: '不是。费用与损伤面积、是否需钣金、喷漆部位有关，实际以到店检测后的确认为准。',
      },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      {
        q: '事故维修一般要检查哪些内容？',
        a: '通常先看外观损伤，必要时拆检确认隐藏损伤、结构件和安全系统，再确认配件与工期。',
      },
      {
        q: '可以先检测再决定是否维修吗？',
        a: '可以。建议先到店评估损伤范围，了解方案后再决定是否施工。',
      },
      {
        q: '事故车维修工期怎么看？',
        a: '工期取决于损伤范围、配件到货和是否涉及结构件，需门店评估后告知，页面不提供线上承诺工期。',
      },
    ],
