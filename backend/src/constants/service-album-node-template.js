...
const ALBUM_NODE_TEMPLATES = {
  maintenance: {
    ...
    nodes: makeStageNodes('maintenance', ['recommended', 'recommended', 'optional', 'recommended']),
  },
  major_maintenance: {
    templateId: 'major_maintenance',
    templateName: '大保养',
    nodes: makeStageNodes('major_maintenance', ['recommended', 'recommended', 'optional', 'recommended']),
  },
  brake: {
    templateId: 'brake',
    templateName: '刹车片/刹车盘',
    serviceItemId: 'item_brake_pad',
    nodes: makeStageNodes('brake', ['recommended', 'recommended', 'recommended', 'recommended']),
  },
  battery: {
    templateId: 'battery',
    templateName: '电瓶更换',
    serviceItemId: 'item_battery',
    nodes: makeStageNodes('battery', ['recommended', 'recommended', 'optional', 'recommended']),
  },
  tire: {
    templateId: 'tire',
    templateName: '轮胎更换',
    nodes: makeStageNodes('tire', ['recommended', 'recommended', 'recommended', 'recommended']),
  },
  ac: {
    templateId: 'ac',
    templateName: '空调服务',
    nodes: makeStageNodes('ac', ['recommended', 'recommended', 'optional', 'recommended']),
  },
  body_paint: {
    templateId: 'body_paint',
    templateName: '钣喷修复',
    serviceItemId: 'item_body_paint',
    nodes: makeStageNodes('body_paint', ['recommended', 'recommended', 'optional', 'required']),
  },
  accident: {
    templateId: 'accident',
    templateName: '事故车维修',
    serviceItemId: 'item_accident',
    nodes: makeStageNodes('accident', ['recommended', 'required', 'optional', 'recommended']),
  },
  default: {
    templateId: 'default',
    templateName: '通用四阶段',
