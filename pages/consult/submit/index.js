...
Page({
  data: {
    ...
    storeLocked: false,
    lockedStoreHint: '',
    platformConsentText: AUTHORIZATION_CONSENT.consult_transfer.text,
    accidentConsentText: AUTHORIZATION_CONSENT.accident_ack.text,
  },
  ...
  buildPayload() {
    ...
    return {
      ...
      accidentConsent: form.accidentConsent,
  ...
  buildAuthorizationConsents() {
    const consents = [
      {
        authType: AUTHORIZATION_CONSENT.consult_transfer.authType,
        authTextVersion: AUTHORIZATION_CONSENT.consult_transfer.version,
        authTextSnapshot: AUTHORIZATION_CONSENT.consult_transfer.text,
      },
    ]
    if (this.data.isAccident && this.data.form.accidentConsent) {
      consents.push({
        authType: AUTHORIZATION_CONSENT.accident_ack.authType,
        authTextVersion: AUTHORIZATION_CONSENT.accident_ack.version,
        authTextSnapshot: AUTHORIZATION_CONSENT.accident_ack.text,
      })
    }
    return consents
  },
